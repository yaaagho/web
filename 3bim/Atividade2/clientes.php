...
<div class="conteudo">
		<div class="estilo">
				...
				<p> <input type="button" href="relatorio-cliente.php" name="relatorio" value="Emitir Relatório"  onClick="chama(this)"></p>
				<a href="mala-direta.php">
				<p> <input type="button" value="Gerar Mala Direta"></p>
				</a>
							...
							<tbody>
									<?php while($cliente = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
											<tr>
													...
													<td>
															<a href="form-edit.php?id=<?php echo $cliente ['idCliente']?>" onClick="chama(this)"> Editar</a>
