	<?php
		...
		$PDO = db_connect();
		$sql = "SELECT nomeFornecedor, email, dataFundacao FROM fornecedores WHERE idFornecedores = :id";
...
<html>
    ...
    <body>
        <div class="navbar navbar-default" id="topo">
            ...
            <div class="conteudo">
			<div class="estilo">
					<form method="post" name="formAltera" action="edit-fornecedor.php" enctype="multipart/form-data" onSubmit="return valida()">
							<h1>EDITAR FORNECEDOR</h1>
							<table width="100%">
									<tr>
										<th width="10%">Nome</th>
										<td width="82%"><input type="text" id="nome" name="txtNome" value="<?php echo $cliente['nomeFornecedor']?>"></td>
									</tr>
									<tr>
										<th width="10%">E-mail</th>
										<td width="82%"><input type="email" id="email" name="txtEmail" value="<?php echo $cliente['email']?>"></td>
									</tr>
									<tr>
										<th>Data de Fundação</th>
										<td><input type="text" name="txtData" id="dataF" value="<?php echo $dataOK ?>" class="calendarioF" readonly></td>
									</tr>
									<tr>
										<input type="hidden" name="id" value="<?php echo $id ?>">
										<td><input type="submit" href="fornecedores.php" name="btnEnviar" value="Cadastrar" onClick="chama(this)"></td>
